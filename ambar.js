function actualizarHabilidades() {
    ...
    localStorage.setItem('habilidadesAdquiridasAmbar', habilidadesAdquiridas);
}

function cargarHabilidades() {
    var habilidadesAdquiridas = localStorage.getItem('habilidadesAdquiridasAmbar');
...
function actualizarCaracteristica(caracteristica, operacion) {
    ...
    localStorage.setItem(caracteristica + 'Ambar', elemento.textContent);
}
...
function cargarCaracteristicas() {
    ...
    caracteristicas.forEach(function(caracteristica) {
        var valor = localStorage.getItem(caracteristica + 'Ambar');
        if (valor) {
