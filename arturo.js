function actualizarHabilidades() {
    ...
    localStorage.setItem('habilidadesAdquiridasArturo', habilidadesAdquiridas);
}

function cargarHabilidades() {
    var habilidadesAdquiridas = localStorage.getItem('habilidadesAdquiridasArturo');
...
function actualizarCaracteristica(caracteristica, operacion) {
    ...
    localStorage.setItem(caracteristica + 'Arturo', elemento.textContent);
}
...
function cargarCaracteristicas() {
    ...
    caracteristicas.forEach(function(caracteristica) {
        var valor = localStorage.getItem(caracteristica + 'Arturo');
        if (valor) {
