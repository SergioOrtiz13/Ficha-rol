function actualizarHabilidades() {
    ...
    localStorage.setItem('habilidadesAdquiridasAdrian', habilidadesAdquiridas);
}

function cargarHabilidades() {
    var habilidadesAdquiridas = localStorage.getItem('habilidadesAdquiridasAdrian');
...
function actualizarCaracteristica(caracteristica, operacion) {
    ...
    localStorage.setItem(caracteristica + 'Adrian', elemento.textContent);
}
...
function cargarCaracteristicas() {
    ...
    caracteristicas.forEach(function(caracteristica) {
        var valor = localStorage.getItem(caracteristica + 'Adrian');
        if (valor) {
