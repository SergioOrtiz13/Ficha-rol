function actualizarHabilidades() {
    ...
    localStorage.setItem('habilidadesAdquiridasOlivia', habilidadesAdquiridas);
}

function cargarHabilidades() {
    var habilidadesAdquiridas = localStorage.getItem('habilidadesAdquiridasOlivia');
...
function sumar(caracteristica) {
    ...
    localStorage.setItem(caracteristica + 'Olivia', valor + 1);
}
...
function cargarCaracteristicas() {
    ...
    caracteristicas.forEach(function(caracteristica) {
        var valor = localStorage.getItem(caracteristica + 'Olivia');
        if (valor) {
